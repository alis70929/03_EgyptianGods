...
class Difficulty:
    def __init__(self, partner):
        ...
        # Populate window
        # Base Frame
        self.difficulty_frame = Frame(bg = full_background)
...
class Game:
    def __init__(self,partner,difficulty,lives):
        ...
        self.Game_frame = Frame(bg=full_background)
...
class Summary():
    def __init__(self,partner,game_history,correct,incorrect,difficulty):
        ...
        # Frame Setup
        self.summary_frame = Frame(bg = full_background)
...
class Export():
    def __init__(self,partner,game_history,correct,incorrect,difficulty):
        ...
        self.export_frame = Frame( bg=background)
